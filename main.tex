...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.75\textwidth]{Figures/EventDisplays/MC/Reconstruction.pdf}\label{fig:examplemcrecoa}} \\
\subfloat[]{\includegraphics[width=0.3\textwidth]{Figures/EventDisplays/MC/ReconstructionU.pdf}\label{fig:examplemcrecob}}
\subfloat[]{\includegraphics[width=0.3\textwidth]{Figures/EventDisplays/MC/ReconstructionV.pdf}\label{fig:examplemcrecoc}}
...
Figure \ref{fig:tbrecopuritycomp} shows the purity and completeness of the reconstructed test beam particle.  Both of these distributions peak at 1, indicating a good reconstruction performance. By referring to figure \ref{fig:tbrecoeffbrkdwn}, it becomes clear that the primary degradation mechanism for purity is mixing of the triggered test beam particle with beam halo overlay, while completeness degrades due to splitting up of the reconstructed test beam particle, even in the absence of any contamination.  \todo{I feel this part needs more, but I don't really know what to say...}

\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/Metrics/MC/Beam/BeamParticleEfficiencyBreakdownVsNHits.pdf}\label{fig:tbrecoeffnhits}}
\subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/Metrics/MC/Beam/BeamParticleEfficiencyBreakdownVsMomentum.pdf}\label{fig:tbrecoeffp}}
\caption{The test beam particle reconstruction efficiency as a function of \protect\subref{fig:tbrecoeffnhits} the number of hits in the test beam particle and \protect\subref{fig:tbrecoeffp} the test beam particle momentum in MC.}
\label{fig:tbrecoeff}
\end{figure}
...
\caption{\protect\subref{fig:tbrecocomp} The purity and \protect\subref{fig:tbrecopur} completeness of reconstructed test beam particles in simulation.}
\label{fig:tbrecopuritycomp}
\end{figure}

\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/Metrics/MC/Beam/Breakdown/BeamParticleEfficiencyBreakdownVsNHits.pdf}\label{fig:tbrecoeffbrkdwnnhits}}
\subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/Metrics/MC/Beam/Breakdown/BeamParticleEfficiencyBreakdownVsMomentum.pdf}\label{fig:tbrecoeffbrkdwnp}} \\
...
\caption{The test beam particle reconstruction efficiency metric when removing cosmic rays and beam halo as a function of \protect\subref{fig:tbrecoeffbrkdwnnhits} number of hits and \protect\subref{fig:tbrecoeffbrkdwnp} momentum.  The completeness and purity of the reconstructed test beam particle are shown in figures \protect\subref{fig:tbrecoeffbrkdwncomp} and \protect\subref{fig:tbrecoeffbrkdwnpur} respectively.}
...
\caption{\protect\subref{fig:crrecocom} the completeness and \protect\subref{fig:crrecopur} purity of reconstructed cosmic ray particles in simulation.}
